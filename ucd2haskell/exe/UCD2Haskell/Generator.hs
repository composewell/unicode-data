...
moduleFileEmitter :: FilePath -> FilePath -> ModuleRecipe a -> Fold a (IO ())
moduleFileEmitter file outdir (modName, fldGen) =
...
runGenerator indir file transformLines outdir recipes = do
    ...
    generatedFolds = recipes <&> \case
      ModuleRecipe     name f -> moduleFileEmitter file outdir (name, f)
