-- autogenerated from https://www.unicode.org/Public/17.0.0/ucd/Blocks.txt
-- |
...
--
-- There is a total of 346 blocks.
--
-- @since 0.3.1
data Block
...
-- | Block definition
--
-- Undefined for values greater than 345.
--
-- Returned value:
--
-- * Lower bound
...
blockDefinition = \case
    ...
    254# -> (# 0x11ee0#, 0x11eff#, "Makasar\0"# #)
    255# -> (# 0x11f00#, 0x11f5f#, "Kawi\0"# #)
    256# -> (# 0x11fb0#, 0x11fbf#, "Lisu Supplement\0"# #)
    257# -> (# 0x11fc0#, 0x11fff#, "Tamil Supplement\0"# #)
    258# -> (# 0x12000#, 0x123ff#, "Cuneiform\0"# #)
    259# -> (# 0x12400#, 0x1247f#, "Cuneiform Numbers and Punctuation\0"# #)
    260# -> (# 0x12480#, 0x1254f#, "Early Dynastic Cuneiform\0"# #)
    261# -> (# 0x12f90#, 0x12fff#, "Cypro-Minoan\0"# #)
    262# -> (# 0x13000#, 0x1342f#, "Egyptian Hieroglyphs\0"# #)
    263# -> (# 0x13430#, 0x1345f#, "Egyptian Hieroglyph Format Controls\0"# #)
    264# -> (# 0x13460#, 0x143ff#, "Egyptian Hieroglyphs Extended-A\0"# #)
    265# -> (# 0x14400#, 0x1467f#, "Anatolian Hieroglyphs\0"# #)
    266# -> (# 0x16100#, 0x1613f#, "Gurung Khema\0"# #)
    267# -> (# 0x16800#, 0x16a3f#, "Bamum Supplement\0"# #)
    268# -> (# 0x16a40#, 0x16a6f#, "Mro\0"# #)
    269# -> (# 0x16a70#, 0x16acf#, "Tangsa\0"# #)
    270# -> (# 0x16ad0#, 0x16aff#, "Bassa Vah\0"# #)
    271# -> (# 0x16b00#, 0x16b8f#, "Pahawh Hmong\0"# #)
    272# -> (# 0x16d40#, 0x16d7f#, "Kirat Rai\0"# #)
    273# -> (# 0x16e40#, 0x16e9f#, "Medefaidrin\0"# #)
    274# -> (# 0x16ea0#, 0x16edf#, "Beria Erfe\0"# #)
    275# -> (# 0x16f00#, 0x16f9f#, "Miao\0"# #)
    276# -> (# 0x16fe0#, 0x16fff#, "Ideographic Symbols and Punctuation\0"# #)
    277# -> (# 0x17000#, 0x187ff#, "Tangut\0"# #)
    278# -> (# 0x18800#, 0x18aff#, "Tangut Components\0"# #)
    279# -> (# 0x18b00#, 0x18cff#, "Khitan Small Script\0"# #)
    280# -> (# 0x18d00#, 0x18d7f#, "Tangut Supplement\0"# #)
    281# -> (# 0x18d80#, 0x18dff#, "Tangut Components Supplement\0"# #)
    282# -> (# 0x1aff0#, 0x1afff#, "Kana Extended-B\0"# #)
    283# -> (# 0x1b000#, 0x1b0ff#, "Kana Supplement\0"# #)
    284# -> (# 0x1b100#, 0x1b12f#, "Kana Extended-A\0"# #)
    285# -> (# 0x1b130#, 0x1b16f#, "Small Kana Extension\0"# #)
    286# -> (# 0x1b170#, 0x1b2ff#, "Nushu\0"# #)
    287# -> (# 0x1bc00#, 0x1bc9f#, "Duployan\0"# #)
    288# -> (# 0x1bca0#, 0x1bcaf#, "Shorthand Format Controls\0"# #)
    289# -> (# 0x1cc00#, 0x1cebf#, "Symbols for Legacy Computing Supplement\0"# #)
    290# -> (# 0x1cec0#, 0x1ceff#, "Miscellaneous Symbols Supplement\0"# #)
    291# -> (# 0x1cf00#, 0x1cfcf#, "Znamenny Musical Notation\0"# #)
    292# -> (# 0x1d000#, 0x1d0ff#, "Byzantine Musical Symbols\0"# #)
    293# -> (# 0x1d100#, 0x1d1ff#, "Musical Symbols\0"# #)
    294# -> (# 0x1d200#, 0x1d24f#, "Ancient Greek Musical Notation\0"# #)
    295# -> (# 0x1d2c0#, 0x1d2df#, "Kaktovik Numerals\0"# #)
    296# -> (# 0x1d2e0#, 0x1d2ff#, "Mayan Numerals\0"# #)
    297# -> (# 0x1d300#, 0x1d35f#, "Tai Xuan Jing Symbols\0"# #)
    298# -> (# 0x1d360#, 0x1d37f#, "Counting Rod Numerals\0"# #)
    299# -> (# 0x1d400#, 0x1d7ff#, "Mathematical Alphanumeric Symbols\0"# #)
    300# -> (# 0x1d800#, 0x1daaf#, "Sutton SignWriting\0"# #)
    301# -> (# 0x1df00#, 0x1dfff#, "Latin Extended-G\0"# #)
    302# -> (# 0x1e000#, 0x1e02f#, "Glagolitic Supplement\0"# #)
    303# -> (# 0x1e030#, 0x1e08f#, "Cyrillic Extended-D\0"# #)
    304# -> (# 0x1e100#, 0x1e14f#, "Nyiakeng Puachue Hmong\0"# #)
    305# -> (# 0x1e290#, 0x1e2bf#, "Toto\0"# #)
    306# -> (# 0x1e2c0#, 0x1e2ff#, "Wancho\0"# #)
    307# -> (# 0x1e4d0#, 0x1e4ff#, "Nag Mundari\0"# #)
    308# -> (# 0x1e5d0#, 0x1e5ff#, "Ol Onal\0"# #)
    309# -> (# 0x1e6c0#, 0x1e6ff#, "Tai Yo\0"# #)
    310# -> (# 0x1e7e0#, 0x1e7ff#, "Ethiopic Extended-B\0"# #)
    311# -> (# 0x1e800#, 0x1e8df#, "Mende Kikakui\0"# #)
    312# -> (# 0x1e900#, 0x1e95f#, "Adlam\0"# #)
    313# -> (# 0x1ec70#, 0x1ecbf#, "Indic Siyaq Numbers\0"# #)
    314# -> (# 0x1ed00#, 0x1ed4f#, "Ottoman Siyaq Numbers\0"# #)
    315# -> (# 0x1ee00#, 0x1eeff#, "Arabic Mathematical Alphabetic Symbols\0"# #)
    316# -> (# 0x1f000#, 0x1f02f#, "Mahjong Tiles\0"# #)
    317# -> (# 0x1f030#, 0x1f09f#, "Domino Tiles\0"# #)
    318# -> (# 0x1f0a0#, 0x1f0ff#, "Playing Cards\0"# #)
    319# -> (# 0x1f100#, 0x1f1ff#, "Enclosed Alphanumeric Supplement\0"# #)
    320# -> (# 0x1f200#, 0x1f2ff#, "Enclosed Ideographic Supplement\0"# #)
    321# -> (# 0x1f300#, 0x1f5ff#, "Miscellaneous Symbols and Pictographs\0"# #)
    322# -> (# 0x1f600#, 0x1f64f#, "Emoticons\0"# #)
    323# -> (# 0x1f650#, 0x1f67f#, "Ornamental Dingbats\0"# #)
    324# -> (# 0x1f680#, 0x1f6ff#, "Transport and Map Symbols\0"# #)
    325# -> (# 0x1f700#, 0x1f77f#, "Alchemical Symbols\0"# #)
    326# -> (# 0x1f780#, 0x1f7ff#, "Geometric Shapes Extended\0"# #)
    327# -> (# 0x1f800#, 0x1f8ff#, "Supplemental Arrows-C\0"# #)
    328# -> (# 0x1f900#, 0x1f9ff#, "Supplemental Symbols and Pictographs\0"# #)
    329# -> (# 0x1fa00#, 0x1fa6f#, "Chess Symbols\0"# #)
    330# -> (# 0x1fa70#, 0x1faff#, "Symbols and Pictographs Extended-A\0"# #)
    331# -> (# 0x1fb00#, 0x1fbff#, "Symbols for Legacy Computing\0"# #)
    332# -> (# 0x20000#, 0x2a6df#, "CJK Unified Ideographs Extension B\0"# #)
    333# -> (# 0x2a700#, 0x2b73f#, "CJK Unified Ideographs Extension C\0"# #)
    334# -> (# 0x2b740#, 0x2b81f#, "CJK Unified Ideographs Extension D\0"# #)
    335# -> (# 0x2b820#, 0x2ceaf#, "CJK Unified Ideographs Extension E\0"# #)
    336# -> (# 0x2ceb0#, 0x2ebef#, "CJK Unified Ideographs Extension F\0"# #)
    337# -> (# 0x2ebf0#, 0x2ee5f#, "CJK Unified Ideographs Extension I\0"# #)
    338# -> (# 0x2f800#, 0x2fa1f#, "CJK Compatibility Ideographs Supplement\0"# #)
    339# -> (# 0x30000#, 0x3134f#, "CJK Unified Ideographs Extension G\0"# #)
    340# -> (# 0x31350#, 0x323af#, "CJK Unified Ideographs Extension H\0"# #)
    341# -> (# 0x323b0#, 0x3347f#, "CJK Unified Ideographs Extension J\0"# #)
    342# -> (# 0xe0000#, 0xe007f#, "Tags\0"# #)
    343# -> (# 0xe0100#, 0xe01ef#, "Variation Selectors Supplement\0"# #)
    344# -> (# 0xf0000#, 0xfffff#, "Supplementary Private Use Area-A\0"# #)
...
rangesBitmap = Ptr
    ...
    \\17\225\27\223\17\1\0\224\17\1\28\255\17\1\0\0\18\33\28\79\18\1\0\128\18\65\28\175\18\1\0\176\18\97\28\255\18\1\0\0\19\129\28\127\19\1\0\128\19\161\28\255\19\1\0\0\20\193\28\127\20\1\0\128\20\225\28\223\20\1\0\128\21\1\29\255\21\1\0\0\22\33\29\95\22\1\0\96\22\65\29\127\22\1\0\128\22\97\29\207\22\1\0\208\22\129\29\255\22\1\0\0\23\161\29\79\23\1\0\0\24\193\29\79\24\1\0\160\24\225\29\255\24\1\0\0\25\1\30\95\25\1\0\160\25\33\30\255\25\1\0\0\26\65\30\79\26\1\0\80\26\97\30\175\26\1\0\176\26\129\30\191\26\1\0\192\26\161\30\255\26\1\0\0\27\193\30\95\27\1\0\96\27\225\30\127\27\1\0\192\27\1\31\255\27\1\0\0\28\33\31\111\28\1\0\112\28\65\31\191\28\1\0\0\29\97\31\95\29\1\0\96\29\129\31\175\29\1\0\176\29\161\31\239\29\1\0\224\30\193\31\255\30\1\0\
    \\0\31\225\31\95\31\1\0\176\31\1\32\191\31\1\0\192\31\33\32\255\31\1\0\0\32\65\32\255\35\1\0\0\36\97\32\127\36\1\0\128\36\129\32\79\37\1\0\144\47\161\32\255\47\1\0\0\48\193\32\47\52\1\0\48\52\225\32\95\52\1\0\96\52\1\33\255\67\1\0\0\68\33\33\127\70\1\0\0\97\65\33\63\97\1\0\0\104\97\33\63\106\1\0\64\106\129\33\111\106\1\0\112\106\161\33\207\106\1\0\208\106\193\33\255\106\1\0\0\107\225\33\143\107\1\0\64\109\1\34\127\109\1\0\64\110\33\34\159\110\1\0\160\110\65\34\223\110\1\0\0\111\97\34\159\111\1\0\224\111\129\34\255\111\1\0\0\112\161\34\255\135\1\0\0\136\193\34\255\138\1\0\0\139\225\34\255\140\1\0\0\141\1\35\127\141\1\0\128\141\33\35\255\141\1\0\240\175\65\35\255\175\1\0\0\176\97\35\255\176\1\0\0\177\129\35\47\177\1\0\48\177\161\35\111\177\1\0\112\177\193\35\255\178\1\
    \\0\0\188\225\35\159\188\1\0\160\188\1\36\175\188\1\0\0\204\33\36\191\206\1\0\192\206\65\36\255\206\1\0\0\207\97\36\207\207\1\0\0\208\129\36\255\208\1\0\0\209\161\36\255\209\1\0\0\210\193\36\79\210\1\0\192\210\225\36\223\210\1\0\224\210\1\37\255\210\1\0\0\211\33\37\95\211\1\0\96\211\65\37\127\211\1\0\0\212\97\37\255\215\1\0\0\216\129\37\175\218\1\0\0\223\161\37\255\223\1\0\0\224\193\37\47\224\1\0\48\224\225\37\143\224\1\0\0\225\1\38\79\225\1\0\144\226\33\38\191\226\1\0\192\226\65\38\255\226\1\0\208\228\97\38\255\228\1\0\208\229\129\38\255\229\1\0\192\230\161\38\255\230\1\0\224\231\193\38\255\231\1\0\0\232\225\38\223\232\1\0\0\233\1\39\95\233\1\0\112\236\33\39\191\236\1\0\0\237\65\39\79\237\1\0\0\238\97\39\255\238\1\0\0\240\129\39\47\240\1\0\48\240\161\39\159\240\1\0\160\240\193\39\255\240\
    \\1\0\0\241\225\39\255\241\1\0\0\242\1\40\255\242\1\0\0\243\33\40\255\245\1\0\0\246\65\40\79\246\1\0\80\246\97\40\127\246\1\0\128\246\129\40\255\246\1\0\0\247\161\40\127\247\1\0\128\247\193\40\255\247\1\0\0\248\225\40\255\248\1\0\0\249\1\41\255\249\1\0\0\250\33\41\111\250\1\0\112\250\65\41\255\250\1\0\0\251\97\41\255\251\1\0\0\0\130\41\223\166\2\0\0\167\162\41\63\183\2\0\64\183\194\41\31\184\2\0\32\184\226\41\175\206\2\0\176\206\2\42\239\235\2\0\240\235\34\42\95\238\2\0\0\248\66\42\31\250\2\0\0\0\99\42\79\19\3\0\80\19\131\42\175\35\3\0\176\35\163\42\127\52\3\0\0\0\206\42\127\0\14\0\0\1\238\42\239\1\14\0\0\0\15\43\255\255\15\0\0\0\48\43\255\255\16\0"#
